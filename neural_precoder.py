...
from models_end import NeuralPrecoder, NeuralPrecoder1D, NeuralPrecoder_1_layer_linear, NeuralPrecoder_1_layer_relu, NeuralReceiver, NeuralReceiverPilot, NeuralReceiverPilotChannel, NeuralPrecoderSIP, NeuralReceiverSIP
...
def main():
    ...
    parser.add_argument('--perfect_csi', type=bool, default=True,
                        help="Use perfect CSI (True/False).")
    parser.add_argument('--cyclic_prefix_length', type=int, default=13,
    ...
    parser.add_argument("--ul_center_frequency", type=float, default=2.00e9,
                        help="Uplink center frequency")
    parser.add_argument("--dl_center_frequency", type=float, default=2.00e9,
    ...
    class Model(tf.keras.Model):
            ...
            if self._domain == "freq":
                ...
                if "baseline" in system:
                    ...
                    if self._precoder_mode == "sip" or self._precoder_mode =="nm_sip":
                        ...
                        if args.pilot_loc is not None:
                            if args.receiver_type == 'pilot_channel':
                                self._neural_receiver = NeuralReceiverPilotChannel(self._num_conv_channels_receiver, self._num_bits_per_symbol)
                            else:
        ...
        def call(self, batch_size, ebno_db):
            ...
            if self._domain == "time":
                ...
                a_freq = a[..., self._rg.cyclic_prefix_length::(self._rg.fft_size + self._rg.cyclic_prefix_length)]
                ...
                if "baseline" in self._system:
                    ...
                    if args.pilot_loc is not None:
                        if args.receiver_type == 'pilot_channel':
                            # Pass h_freq directly to the receiver - the model handles reshaping internally
                            llr = self._neural_receiver([y, tf.squeeze(x_rg_pilot, axis=[1]), h_freq, no])
                        else:
