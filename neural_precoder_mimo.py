...
def main():
    ...
    parser.add_argument('--precoder_arch', choices=['full', 'linear_1l', 'time_1D', 'freq_1D'], 
    ...
    parser.add_argument('--results_folder', type=str, default="results_sep_mimo_inf/models_end",
    ...
    class Model(tf.keras.Model):
        def __init__(self,
            ...
            self._num_ut_ant = 2#args.num_ut_ant
            self._num_bs_ant = 2#args.num_bs_ant
            ...
            self._num_filters = 2#args.num_bs_ant
